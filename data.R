...
#packages <- c("shiny", "shinythemes", "dplyr", "lubridate", "ggplot2", "plotly", "readr")
...
data_ulule <- readr::read_csv(
  "C:/Users/LENOVO/Desktop/M1/ulule/data_ulule_2025_new.csv",
...
data_ulule$D�but <- format(data$D�but, "%Y-%m-%d %H:%M")
